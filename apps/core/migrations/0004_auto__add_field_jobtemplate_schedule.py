...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'core.checkprogress': {
            ...
            'datestart':
                ('django.db.models.fields.DateTimeField', [], {
                 'default': 'datetime.datetime(2015, 7, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.distrotemplate': {
            'Meta':
                {'ordering': "('name', 'distroname')",
                 'object_name': 'DistroTemplate'},
            'distroname': ('django.db.models.fields.CharField', [], {
                           'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'family': ('django.db.models.fields.CharField', [], {
                       'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name':
                ('django.db.models.fields.CharField',
        ...
        u'core.grouptasktemplate': {
            ...
            'priority':
                ('django.db.models.fields.SmallIntegerField',
                 [], {'default': '0'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {
                       'related_name': "'grouptemplates'", 'to': u"orm['core.RecipeTemplate']"}),
        ...
        u'core.recipe': {
            ...
            'distro':
                ('django.db.models.fields.related.ForeignKey',
                 [], {'to': u"orm['core.Distro']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {
                    'related_name': "'recipes'", 'to': u"orm['core.Job']"}),
            'parentrecipe': ('django.db.models.fields.related.ForeignKey', [], {
                             'to': u"orm['core.Recipe']", 'null': 'True', 'blank': 'True'}),
            'result':
                ('django.db.models.fields.SmallIntegerField',
                 [], {'default': '0'}),
            'resultrate':
        ...
        u'core.recipetemplate': {
            ...
            'arch': ('django.db.models.fields.related.ManyToManyField',
                     [], {'to': u"orm['core.Arch']", 'symmetrical': 'False'}),
            'disk':
                ('django.db.models.fields.CharField',
                 [], {'max_length': '255', 'blank': 'True'}),
            'distro':
                ('django.db.models.fields.related.ForeignKey',
                 [], {'to': u"orm['core.DistroTemplate']"}),
            'hvm':
                ('django.db.models.fields.BooleanField',
                 [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_virtualguest':
                ('django.db.models.fields.BooleanField',
                 [], {'default': 'False'}),
            'jobtemplate': ('django.db.models.fields.related.ForeignKey', [], {
                            'related_name': "'trecipes'", 'to': u"orm['core.JobTemplate']"}),
            'kernel_options':
                ('django.db.models.fields.CharField',
                 [], {'max_length': '255', 'blank': 'True'}),
            'kernel_options_post':
            ...
            'schedule':
                ('django.db.models.fields.CharField',
                 [], {'max_length': '255', 'blank': 'True'}),
            'virtualhost': ('django.db.models.fields.related.ForeignKey', [], {
                            'blank': 'True', 'related_name': "'virtualguests'", 'null': 'True', 'to': u"orm['core.RecipeTemplate']"})
        },
        u'core.skippedphase': {
        ...
        u'core.system': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {
                       'to': u"orm['core.System']", 'null': 'True', 'blank': 'True'}),
            'ram':
        ...
        u'core.tasktemplate': {
            ...
            'priority':
                ('django.db.models.fields.SmallIntegerField',
                 [], {'default': '0'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {
                       'related_name': "'tasks'", 'to': u"orm['core.RecipeTemplate']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {
                     'to': u"orm['core.TaskRoleEnum']", 'null': 'True', 'blank': 'True'}),
            'test':
                ('django.db.models.fields.related.ForeignKey',
        ...
        u'core.test': {
            ...
            'dependencies': ('django.db.models.fields.related.ManyToManyField', [], {
                             'to': u"orm['core.Test']", 'symmetrical': 'False', 'blank': 'True'}),
            'description':
                ('django.db.models.fields.TextField',
                 [], {'null': 'True', 'blank': 'True'}),
            'folder': ('django.db.models.fields.CharField', [], {
                       'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'git': ('django.db.models.fields.related.ForeignKey', [], {
                    'to': u"orm['core.Git']", 'null': 'True', 'blank': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {
                       'to': u"orm['core.GroupOwner']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enable':
                ('django.db.models.fields.BooleanField',
                 [], {'default': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey',
                      [], {'to': u"orm['core.Author']", 'null': 'True'}),
            'time': ('django.db.models.fields.CharField', [], {
        ...
        u'taggit.taggeditem': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {
                             'related_name': "u'taggit_taggeditem_tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id':
                ('django.db.models.fields.IntegerField',
                 [], {'db_index': 'True'}),
