    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(
                    default=b'unknow@redhat.com', max_length=75)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datestart', models.DateTimeField(
                    default=datetime.datetime(2015, 8, 13, 13, 35, 7, 839572, tzinfo=utc))),
            ...
            fields=[
                ('id',
                 models.AutoField(verbose_name='ID',
                                  ...
                                  primary_key=True)),
                ('name',
                 models.CharField(help_text=b'Only alias',
                                  max_length=255,
                                  blank=True)),
                ('family',
                ...
                (
                    'distroname',
                    models.CharField(
                        help_text=b'If field is empty, then it will use latest compose.',
                        max_length=255,
                        null=True,
                        blank=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.SmallIntegerField(default=0)),
                ('group',
                 models.ForeignKey(related_name='grouptests',
                                   to='core.GroupTemplate')),
            ],
            options={
                'ordering': ('priority',),
            },
            ...
            fields=[
                ...
                ('schedule',
                 models.ForeignKey(blank=True,
                                   to='taskomatic.TaskPeriodSchedule',
                                   null=True)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'grouprecipes',
                    models.CharField(
                        help_text=b'example: {{arch}} {{whiteboard|nostartsdate}}',
                        max_length=255,
                        blank=True)),
                ('schedule',
                 models.ForeignKey(blank=True,
                                   to='taskomatic.TaskPeriod',
                                   null=True)),
                ('tags',
                 taggit.managers.TaggableManager(to='taggit.Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(
                    related_name='recipes', to='core.Job')),
                ('parentrecipe',
                 models.ForeignKey(blank=True,
                                   to='core.Recipe',
                                   null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.SmallIntegerField(
                    default=0, choices=[(0, b'None'), (1, b'RECIPE_MEMBERS'), (2, b'STANDALONE')])),
                ('memory', models.CharField(max_length=255, blank=True)),
                ('disk',
                 models.CharField(help_text=b'Value is in GB',
                                  max_length=255,
                                  blank=True)),
                ...
                ('schedule',
                 models.CharField(max_length=255,
                                  verbose_name=b'schedule period',
                                  blank=True)),
                ('arch', models.ManyToManyField(to='core.Arch')),
                ('distro', models.ForeignKey(to='core.DistroTemplate')),
                ('jobtemplate',
                 models.ForeignKey(related_name='trecipes',
                                   to='core.JobTemplate')),
                ('virtualhost',
                 models.ForeignKey(related_name='virtualguests',
                                   blank=True,
                                   to='core.RecipeTemplate',
                                   null=True)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datestart', apps.core.utils.date_helpers.TZDateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.SmallIntegerField(default=0)),
                ('recipe',
                 models.ForeignKey(related_name='tasks',
                                   to='core.RecipeTemplate')),
                ('role',
                 models.ForeignKey(blank=True,
                                   to='core.TaskRoleEnum',
                                   null=True)),
            ],
            options={
            },
